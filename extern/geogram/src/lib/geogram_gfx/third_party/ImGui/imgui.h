...
struct ImFontAtlas
{
    ...
    struct GlyphRangesBuilder
    {
        ...
        void           SetBit(int n)        { UsedChars[n >> 3] |= (unsigned char) (1 << (n & 7)); }  // Set bit 'c' in the array [Bruno Levy] added cast to silent warning
...
// [Bruno]
namespace ImGui {
    void debug_printf(const char* fmt, ...) IM_FMTARGS(1);
